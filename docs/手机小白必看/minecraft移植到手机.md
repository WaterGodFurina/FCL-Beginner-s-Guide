...
**间接跑：能！** 用 **[PojavLauncher](https://github.com/PojavLauncherTeam/PojavLauncher)（已停更） / [Amethyst](https://github.com/Amethyst-Launcher/Amethyst) / Fold Craft Launcher / [Zalith Launcher](https://github.com/ZalithLauncher/ZalithLauncher)** 等启动器，可以把电脑 Java 版「移植」到手机。下面讲清楚原理。
...
- **[Amethyst](https://github.com/Amethyst-Launcher/Amethyst)**（安卓 / iOS）：PojavLauncher 团队的官方续作
- **HMCL PE**（安卓）：老牌，但停更。
- **Fold Craft Launcher**（安卓）：国产，优化好。
- **[Zalith Launcher](https://github.com/ZalithLauncher/ZalithLauncher)**（安卓）：基于 PojavLauncher 二改的启动器，拥有更好的 UI 和更多的功能。
